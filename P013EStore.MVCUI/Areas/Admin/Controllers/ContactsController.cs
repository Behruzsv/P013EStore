...
namespace P013EStore.MVCUI.Areas.Admin.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public ActionResult Create() // control et 
        {
            return View();
        }
        ...
        public async Task<ActionResult> Create(Contact collection) // control et 
        {
            try
            {
        ...
        public async Task<ActionResult> Edit(int id) // control et 
        {
        ...
        public async Task<ActionResult> DeleteAsync(int id) // control et 
        {
            var model = await _service.FindAsync(id);
            return View(model);
        }
