...
namespace P013EStore.MVCUI.Areas.Admin.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return Redirect("/Admin/Login"); // tekrardan girşi sayfasına yönlendir
        }
        [HttpPost]
        public async Task<IActionResult> IndexAsync(AdminLoginViewModel admin)
        {
            try
            {
                ...
                if (kullanici != null)
                {
                    ...
                    await HttpContext.SignInAsync(principal); // HttpContext .net içerisinden geliiyor ve uygulamanın çalışma anındaki içeriğe ulaşmamızı sağlıyor. SignInAsync metodu da .net içerisinde mevcut login işlemi yapmak istersek buradaki gibi kullanıyoruz.
