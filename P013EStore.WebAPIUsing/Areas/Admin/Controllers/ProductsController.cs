...
namespace P013EStore.WebAPIUsing.Areas.Admin.Controllers
{
	...
	public class ProductsController : Controller
	{
		...
		private readonly string _apiAdres = "https://localhost:7101/api/Products";
		private readonly string _apiAdresKategori = "https://localhost:7101/api/Categories";
		private readonly string _apiAdresMarka = "https://localhost:7101/api/Brands";
