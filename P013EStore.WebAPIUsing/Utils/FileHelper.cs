namespace P013EStore.WebAPIUsing.Utils
{
    public class FileHelper
    {
        ...
        public static bool FileRemove(string fileName, string filePath = "/wwwroot/Img/")
        {
            string directory = Directory.GetCurrentDirectory() + filePath + fileName;
            if (File.Exists(directory)) // File.Exist metodu .net içinde var olan ve kendisine verilen dizinde dosya var mı yok mu kontrol eden bir metottur
            {
